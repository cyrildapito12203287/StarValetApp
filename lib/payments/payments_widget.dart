          ...
          child: AppBar(
            ...
            title: Column(
              ...
              children: [
                ...
                Text(
                  'Choose active payment or Add new one',
                ...
                Padding(
                  ...
                  child: StreamBuilder<List<PaymentsRecord>>(
                    stream: queryPaymentsRecord(
                      queryBuilder: (paymentsRecord) => paymentsRecord.where(
                        'uid',
                                      ...
                                      child: Padding(
                                        ...
                                        child: ClipRRect(
                                          borderRadius:
                                              BorderRadius.circular(50.0),
                                          child: Image.network(
                                            'https://static.vecteezy.com/system/resources/previews/007/945/462/original/credit-card-payment-solid-line-icon-design-concept-for-web-and-ui-simple-icon-suitable-for-any-purposes-free-vector.jpg',
                                            width: 44.0,
                                            height: 44.0,
                                            fit: BoxFit.cover,
                                          ),
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        return Theme(
                                          ...
                                          child: CheckboxListTile(
                                            ...
                                            title: Text(
                                              listViewPaymentsRecord.cardnumber,
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyLarge
                                                      .override(
                                            ...
                                            subtitle: Text(
                                              listViewPaymentsRecord.nameoncard,
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodySmall
                                                      .override(
                      ...
                      child: StreamBuilder<List<VehiclesRecord>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          return FFButtonWidget(
                            onPressed: () async {
                              context.pushNamed('PaymentSetActive');
                            },
                            text: 'Set to Active',
